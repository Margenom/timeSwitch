...
(define (dlgt-begin-start beg) (cadr beg))
(define (dlgt-begin-planed beg) (caddr beg))
(define (dlgt-begin-descr beg) (cadddr beg))
; write
...
(define (dlgt-end-stop end) (cadr end))
(define (dlgt-end-comment end) (caddr end))
; write
...
(define (dlgt-part-start wait) (cadr wait))
...
(define (dlgt-wait-start wait) (cadr wait))
(define (dlgt-wait-end wait) (cadr wait))
(define (dlgt-wait-length wait) (- (caddr wait) (cadr wait)))
(define (dlgt-wait-descr wait) (cadddr wait))
; write
